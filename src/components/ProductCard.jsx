  ...
  return (
    <article className="product-card">
      <div className="product-card__img-wrap">
        ...
        />
        <span className={`badge ${availability === 'In Stock' ? 'badge-stock' : 'badge-limited'} product-card__badge`}>
          {availability}
        </span>
      </div>
      <div className="product-card__body">
        <p className="product-card__collection">{collection}</p>
        <h3 className="product-card__name">{name}</h3>
        <p className="product-card__fabric">{fabric}</p>
